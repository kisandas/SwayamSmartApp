...
public class Adapter_calery extends BaseAdapter {

    LayoutInflater flater;
    ArrayList<Model_Calories> Arr_Calery;
    Context context;

    public Adapter_calery(Activity context, ArrayList<Model_Calories> list) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        txtTitle.setText(Arr_Calery.get(position).getT_ItemName());
        ImageView imageView = (ImageView) view.findViewById(R.id.imgcalry);
        Log.e("TXTTIEL==", Arr_Calery.get(position).getT_ItemName() + " POSTIION" + position + " IMAGE " + Arr_Calery.get(position).getT_Imagename());
